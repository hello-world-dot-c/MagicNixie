...
static const netVars_t netVarsTable[] = {
  ...
  { "USE12HDISP"        , TYPE_BOOL   , &gConf.use12hDisplay         , { "show12hDisplayButton"     , "show12hStatus"            } },
  { "SHOWLEAD0HR"       , TYPE_BOOL   , &gConf.showLeading0Hour      , { "hoursLeadingZeroesButton" , "leadingZeroesStatus"      } },
  { "SHOWLEAD0DT"       , TYPE_BOOL   , &gConf.showLeading0Date      , { "dateLeadingZeroesButton"  , "dateLeadingZeroesStatus"  } },
  { "SYNCRTC"           , TYPE_BOOL   , &gConf.syncRTC               , { "" , "" } },
  { "QUIETNIGHTS"       , TYPE_BOOL   , &gConf.quietNights           , { "quietNightsButton"        , "quietNightsStatus"        } },
